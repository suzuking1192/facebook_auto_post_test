...
class JoboffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joboffer" do
    assert_difference('Joboffer.count') do
      post joboffers_url, params: { joboffer: { job_description: @joboffer.job_description, job_title: @joboffer.job_title, minimum_japaneseskill: @joboffer.minimum_japaneseskill, place: @joboffer.place, salary: @joboffer.salary, shift: @joboffer.shift } }
    end
  ...
  test "should update joboffer" do
    patch joboffer_url(@joboffer), params: { joboffer: { job_description: @joboffer.job_description, job_title: @joboffer.job_title, minimum_japaneseskill: @joboffer.minimum_japaneseskill, place: @joboffer.place, salary: @joboffer.salary, shift: @joboffer.shift } }
